...
'''
    ...
    def extract_real_paths_with_angr(self, binary_path: Path, max_paths: int = 20) -> List[Dict]:
        ...
        try:
            ...
            state.solver.add(count_sym <= 4)  # 限制count范围避免路径爆炸
    ...
    def _fallback_mock_paths(self, binary_path: Path, max_paths: int) -> List[Dict]:
        ...
        function_name = binary_path.stem.split('_')[0]  # 提取函数名
...
def main():
    ...
    # 选择要测试的benchmark（先从简单的开始）
    test_benchmarks = ['s000', 's1112', 's121']  # 从简单的开始
