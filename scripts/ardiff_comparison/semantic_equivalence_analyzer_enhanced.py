...
class EnhancedPathAnalyzer:
    ...
    def find_equivalent_paths_enhanced(self, paths1, paths2):
        ...
        print(f"\nStarting enhanced equivalence verification ({total_comparisons} pairs):")
        ...
        for i, path1 in enumerate(paths1):
            ...
            for j, path2 in enumerate(paths2):
                ...
                if current_comparison > 1:
                    ...
                    print(f"  Compare {i+1}-{j+1} ({current_comparison}/{total_comparisons}, {current_comparison/total_comparisons*100:.1f}%) "
